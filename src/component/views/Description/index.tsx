        ...
        <div className="relative basis-1/2  gap-6 lg:gap-10 grid grid-cols-2 grid-rows-2">
          ...
          <div className="max-w-[13rem] space-y-2">
            ...
            <p className="text-lg leading-5">
              Using good quality materials ensures durability and customer
              satisfaction.
            </p>
          </div>
          <div className="max-w-[13rem] space-y-2">
            ...
            <p className="text-lg leading-5">
              100% handmade products reflect craftsmanship and attention to
              detail.
            </p>
          </div>
          <div className="max-w-[13rem] space-y-2">
            ...
            <p className="text-lg leading-5">
              Modern fashion design blends innovation and style, shaping
              contemporary trends.
            </p>
          </div>
          <div className="max-w-[13rem] space-y-2">
            ...
            <p className="text-lg leading-5">
              Discount available for bulk orders, inquire for pricing benefits.
            </p>
          </div>
        </div>
