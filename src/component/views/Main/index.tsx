    ...
    return(
        <div className='py-5 flex justify-between items-center'>
            <div className='space-y-7 max-w-[24rem]'>
                <button className='px-4 py-2 bg-primaryWhite rounded-md text-purple-900 font-medium'>Sales 70%</button>
                <h1 className='text-5xl text-gray-800 font-bold'>An Industrial Take on Streetwear</h1>
                <p>Anyone can beat you but no one can beat your outfit as long as you wear Dine outfits.</p>
                <button className='bg-gray-900 px-5 py-3 text-lg text-white font-semibold rounded-sm ring-1 
