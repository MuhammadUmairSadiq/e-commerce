...
const SignupFormComp = () => {
  ...
  // Provide a default value if the contextValue is null
  let {
    errorsOfFirebase = { errorMessage: "" },
    signUpUser = () => {},
    userData = null,
    signUpViaGoogle = () => {},
    loading = false,
  ...
  const handleSignup = () => {
    ...
    if (!password || password.length < 6) {
      validationErrors.password = "Password is required and Minimum 6 characters";
    }
